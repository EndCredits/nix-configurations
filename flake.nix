{
  ...
  nixConfig = {
    ...
    trusted-public-keys = [
      # public key for nixos official cache server
  ...
  inputs = {
    ...
    nixpkgs.url = "github:NixOS/nixpkgs/50071d87c75300c037e28439c5176c3933b9fce5";
  ...
  outputs = { self, nixpkgs, ... }@inputs: {
    nixosConfigurations = {
      ...
      # its hostname, so the system named `nixos-main` will use this one.
