...

{
  ...
  environment.systemPackages = with pkgs; [
    ...
    glfw-wayland xwayland wev wf-recorder alsa-lib alsa-utils mako libsForQt5.qt5.qtwayland xdg-desktop-portal-hyprland libsForQt5.polkit-kde-agent brightnessctl 
  ];
